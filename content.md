...
Formatting you can use inside a section:
  **bold text**
  *italic text*
...
but the text underneath is all yours.

After editing, regenerate the page with:
...
### partners
<!--
  One partner per line:

    - Name | https://partner-site.com | logo-file.svg

  Only "Name" is required — url and logo can be left blank:
    - Name                                  (plain text tile, no link)
    - Name | https://partner-site.com       (text tile, clicks through)
    - Name | https://partner-site.com | logo-file.svg   (logo tile, clicks through)

  Logo files go in images/partners/ — reference them by filename only.
  If a logo filename is given but the file isn't there yet, the tile
  just falls back to showing the name as text (build will warn you).

  Prefix the name with "?" for a partner that isn't confirmed yet
  (renders as an orange badge instead of a normal tile):
    - ? Name | https://partner-site.com
-->
- Cosmik | https://cosmik.network/ | cosmik_logo-full.svg
- Discourse Graphs | https://discoursegraphs.com/ | discourse-graphs-logo.svg
- MIRA | https://www.mira.science/ | mira-logo.svg
- eLife Pathways | https://elifepathways.org/ | elife-pathways-logo.svg
- ATScience | https://atproto.science/ | ATScience-Logo-RGB-Black.svg
- Catalyze | https://catalyzernd.com/ | catalyze-logo.png
